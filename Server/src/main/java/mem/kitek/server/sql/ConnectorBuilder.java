...
public class ConnectorBuilder {
    ...
    private boolean trackOpenResources = true;
    private String localSocketAddress;

    public ConnectorBuilder() {}

    /**
     * Use {@link ConnectorBuilder#setHost(String)} and then instead.
     */
    @Deprecated
    ...
    public ConnectorBuilder setLocalSocketAddress(String address) {
    ...
    public ConnectorBuilder setTrackOpenResources(boolean value) {
        this.trackOpenResources = value;
        return this;
    }
    ...
    public Connector build(boolean initialize) {
        ...
        if(!this.trackOpenResources)
            urlBuilder.append("&dontTrackOpenResources=true");
        if(this.autoReconnect)
            urlBuilder.append("&autoReconnect=true&maxReconnects=").append(this.retries);
        if(this.localSocketAddress != null)
            urlBuilder.append("&localSocketAddress=").append(this.localSocketAddress);
